...
export default function CreditsPage() {
  return (
    <main 
      className="flex min-h-[100dvh] w-full flex-col p-4 sm:p-12 relative overflow-x-hidden overflow-y-auto bg-cover bg-center bg-no-repeat"
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto flex flex-col justify-start lg:justify-center min-h-full pt-20 pb-12 lg:py-0">
        <div className="flex flex-col mb-8 sm:mb-12 pr-16 lg:pr-0">
          ...
          <h1 className="font-thick text-[3rem] leading-none sm:text-7xl lg:text-[10rem] text-white uppercase drop-shadow-[0_4px_0_rgba(255,51,51,1)] break-words">
            CREDITS
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 w-full relative">
          ...
          {credits.map((credit, idx) => (
            ...
            >
              ...
              <div className="font-thick text-[1.5rem] leading-[1.1] sm:text-4xl uppercase text-black break-words">
                {credit.name}
              </div>
              <div className="font-space font-bold text-black/60 text-[10px] sm:text-xs mt-3 sm:mt-4 bg-black/5 p-2 border-l-4 border-black self-start md:self-auto">
